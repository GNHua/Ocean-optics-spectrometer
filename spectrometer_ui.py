...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButtonOpenDev = QtGui.QPushButton(self.groupBox)
        self.pushButtonOpenDev.setObjectName(_fromUtf8("pushButtonOpenDev"))
        self.horizontalLayout_3.addWidget(self.pushButtonOpenDev)
        self.pushButtonSpectrum = QtGui.QPushButton(self.groupBox)
        self.pushButtonSpectrum.setEnabled(False)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButtonSpectrum.sizePolicy().hasHeightForWidth())
        self.pushButtonSpectrum.setSizePolicy(sizePolicy)
        ...
        self.radioButton100um = QtGui.QRadioButton(self.groupBox)
        ...
        self.radioButton1000um = QtGui.QRadioButton(self.groupBox)
        ...
        self.checkBoxSlit = QtGui.QCheckBox(self.groupBox)
        self.checkBoxSlit.setObjectName(_fromUtf8("checkBoxSlit"))
        self.horizontalLayout_3.addWidget(self.checkBoxSlit)
        ...
        self.gridLayout.addWidget(self.mplwindow, 1, 0, 1, 1)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/icon/icon/Connected.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox.setTitle(_translate("MainWindow", "Spectrometer", None))
        self.pushButtonOpenDev.setText(_translate("MainWindow", "Open", None))
        self.pushButtonSpectrum.setToolTip(_translate("MainWindow", "Acquire spectrum", None))
        self.pushButtonSpectrum.setText(_translate("MainWindow", "Spectrum", None))
        self.label.setText(_translate("MainWindow", "Integration Time (ms):", None))
        self.pushButtonSetInt.setText(_translate("MainWindow", "Set", None))
        self.label_2.setText(_translate("MainWindow", "Fiber:", None))
